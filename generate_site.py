    ...
    <section class="py-20 bg-camo-900/30 border-y border-camo-800">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12 scroll-reveal opacity-0 translate-y-8 transition-all duration-700 ease-out">
                ...
                <p class="text-zinc-400 max-w-2xl mx-auto">Live sites built for real clients. Click any card to open the project.</p>
            </div>
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 scroll-reveal opacity-0 translate-y-8 transition-all duration-700 ease-out">
                ...
                <!-- CamoDevOps Online — full case study -->
                <a href="https://camodevops.online" target="_blank" rel="noopener noreferrer" class="group flex flex-col rounded-xl overflow-hidden bg-camo-950 border border-camo-800 hover:border-camo-accent/60 hover:shadow-[0_0_30px_rgba(20,184,166,0.15)] transition-all duration-300">
                    <div class="h-40 bg-gradient-to-br from-camo-accent/20 via-camo-800 to-camo-950 flex items-center justify-center relative">
                    ...
                    <div class="p-5 flex flex-col flex-grow">
                        ...
                        <div class="space-y-1.5 text-xs text-zinc-400 flex-grow">
                            <p><span class="text-zinc-300 font-semibold">Challenge:</span> Sovereign portfolio site, globally fast, zero runtime cost.</p>
                            <p><span class="text-zinc-300 font-semibold">Stack:</span> Python generator &middot; TailwindCSS &middot; Cloudflare Workers edge.</p>
                            <p><span class="text-zinc-300 font-semibold">Result:</span> 9-page site, &lt;2 min deploys, R0 hosting, 100% uptime.</p>
                        </div>
                ...
                <!-- Rave Bingochi -->
                <a href="https://www.ravebingochi.com/" target="_blank" rel="noopener noreferrer" class="group flex flex-col rounded-xl overflow-hidden bg-camo-950 border border-camo-800 hover:border-camo-accent/60 hover:shadow-[0_0_30px_rgba(20,184,166,0.15)] transition-all duration-300">
                    <div class="h-40 bg-gradient-to-br from-purple-900/40 via-camo-800 to-camo-950 flex items-center justify-center relative">
                        <span class="font-mono text-purple-300 text-sm">ravebingochi.com</span>
                        <span class="absolute top-3 right-3 text-xs font-mono text-purple-300 bg-purple-900/30 border border-purple-700/30 px-2 py-0.5 rounded">Entertainment</span>
                    </div>
                    <div class="p-5 flex flex-col flex-grow">
                        <h3 class="text-white font-semibold mb-2">Rave Bingochi</h3>
                        <p class="text-xs text-zinc-400 flex-grow">Entertainment &amp; creative brand site. Bold visual identity with high-impact design built to capture the energy of the brand.</p>
                        <p class="text-xs text-camo-accent mt-3 group-hover:underline">Visit site &rarr;</p>
                    </div>
                </a>

                <!-- IRL Events -->
                <a href="https://www.irlevents.fun/" target="_blank" rel="noopener noreferrer" class="group flex flex-col rounded-xl overflow-hidden bg-camo-950 border border-camo-800 hover:border-camo-accent/60 hover:shadow-[0_0_30px_rgba(20,184,166,0.15)] transition-all duration-300">
                    <div class="h-40 bg-gradient-to-br from-orange-900/40 via-camo-800 to-camo-950 flex items-center justify-center relative">
                        <span class="font-mono text-orange-300 text-sm">irlevents.fun</span>
                        <span class="absolute top-3 right-3 text-xs font-mono text-orange-300 bg-orange-900/30 border border-orange-700/30 px-2 py-0.5 rounded">Events</span>
                    </div>
                    <div class="p-5 flex flex-col flex-grow">
                        <h3 class="text-white font-semibold mb-2">IRL Events</h3>
                        <p class="text-xs text-zinc-400 flex-grow">Event company web presence &mdash; designed to convert visitors into bookings with clear calls to action and a clean, energetic layout.</p>
                        <p class="text-xs text-camo-accent mt-3 group-hover:underline">Visit site &rarr;</p>
                    </div>
                </a>

                <!-- 79Ratio -->
                <a href="https://79ratio.com/" target="_blank" rel="noopener noreferrer" class="group flex flex-col rounded-xl overflow-hidden bg-camo-950 border border-camo-800 hover:border-camo-accent/60 hover:shadow-[0_0_30px_rgba(20,184,166,0.15)] transition-all duration-300">
                    <div class="h-40 bg-gradient-to-br from-blue-900/40 via-camo-800 to-camo-950 flex items-center justify-center relative">
                        <span class="font-mono text-blue-300 text-sm">79ratio.com</span>
                        <span class="absolute top-3 right-3 text-xs font-mono text-blue-300 bg-blue-900/30 border border-blue-700/30 px-2 py-0.5 rounded">Creative</span>
                    </div>
                    <div class="p-5 flex flex-col flex-grow">
                        <h3 class="text-white font-semibold mb-2">79Ratio</h3>
                        <p class="text-xs text-zinc-400 flex-grow">Creative studio or agency site with a distinct identity &mdash; refined layout, purposeful typography and a strong brand presence.</p>
                        <p class="text-xs text-camo-accent mt-3 group-hover:underline">Visit site &rarr;</p>
                    </div>
                </a>

                <!-- Beloveful -->
                <a href="https://beloveful.com/" target="_blank" rel="noopener noreferrer" class="group flex flex-col rounded-xl overflow-hidden bg-camo-950 border border-camo-800 hover:border-camo-accent/60 hover:shadow-[0_0_30px_rgba(20,184,166,0.15)] transition-all duration-300">
                    <div class="h-40 bg-gradient-to-br from-rose-900/40 via-camo-800 to-camo-950 flex items-center justify-center relative">
                        <span class="font-mono text-rose-300 text-sm">beloveful.com</span>
                        <span class="absolute top-3 right-3 text-xs font-mono text-rose-300 bg-rose-900/30 border border-rose-700/30 px-2 py-0.5 rounded">Lifestyle</span>
                    </div>
                    <div class="p-5 flex flex-col flex-grow">
                        <h3 class="text-white font-semibold mb-2">Beloveful</h3>
                        <p class="text-xs text-zinc-400 flex-grow">Lifestyle and lifestyle brand site built with warmth and elegance &mdash; designed to build emotional connection with the audience from the first scroll.</p>
                        <p class="text-xs text-camo-accent mt-3 group-hover:underline">Visit site &rarr;</p>
                    </div>
                </a>

                <!-- Buddies Worldwide -->
                <a href="https://buddiesworldwide.store/" target="_blank" rel="noopener noreferrer" class="group flex flex-col rounded-xl overflow-hidden bg-camo-950 border border-camo-800 hover:border-camo-accent/60 hover:shadow-[0_0_30px_rgba(20,184,166,0.15)] transition-all duration-300">
                    <div class="h-40 bg-gradient-to-br from-green-900/40 via-camo-800 to-camo-950 flex items-center justify-center relative">
                        <span class="font-mono text-green-300 text-sm">buddiesworldwide.store</span>
                        <span class="absolute top-3 right-3 text-xs font-mono text-green-300 bg-green-900/30 border border-green-700/30 px-2 py-0.5 rounded">E-commerce</span>
                    </div>
                    <div class="p-5 flex flex-col flex-grow">
                        <h3 class="text-white font-semibold mb-2">Buddies Worldwide</h3>
                        <p class="text-xs text-zinc-400 flex-grow">E-commerce store built for global reach &mdash; clean product layout, optimized for conversion, with a playful and community-driven brand voice.</p>
                        <p class="text-xs text-camo-accent mt-3 group-hover:underline">Visit site &rarr;</p>
                    </div>
                </a>

                <!-- Yong's Security -->
                <a href="https://www.yongssecuriecom.com/" target="_blank" rel="noopener noreferrer" class="group flex flex-col rounded-xl overflow-hidden bg-camo-950 border border-camo-800 hover:border-camo-accent/60 hover:shadow-[0_0_30px_rgba(20,184,166,0.15)] transition-all duration-300">
                    <div class="h-40 bg-gradient-to-br from-zinc-700/40 via-camo-800 to-camo-950 flex items-center justify-center relative">
                        <span class="font-mono text-zinc-300 text-sm">yongssecuriecom.com</span>
                        <span class="absolute top-3 right-3 text-xs font-mono text-zinc-300 bg-zinc-700/30 border border-zinc-600/30 px-2 py-0.5 rounded">Security</span>
                    </div>
                    <div class="p-5 flex flex-col flex-grow">
                        <h3 class="text-white font-semibold mb-2">Yong&apos;s Security</h3>
                        <p class="text-xs text-zinc-400 flex-grow">Corporate security company site &mdash; professional, trustworthy design that communicates reliability and authority to potential clients from first glance.</p>
                        <p class="text-xs text-camo-accent mt-3 group-hover:underline">Visit site &rarr;</p>
                    </div>
                </a>
